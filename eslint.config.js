...
export default defineConfig(
	...
	// Not this app's sources: the vendored form library (its own config),
	// vendored content bundles / raw material, docs and container tooling.
	{ ignores: ['packages/', '.initialData/', 'content/', 'docs/', 'docker/', '.phase-runner/'] },
